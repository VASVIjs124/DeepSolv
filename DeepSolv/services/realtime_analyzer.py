...
class RealtimeStoreAnalyzer:
    ...
    async def _parse_comprehensive_content(self, main_url: str, scraped_content: Dict[str, Any]) -> BrandContext:
        ...
        # Parse hero products (your requirement: Hero Products)
        logger.info("🌟 Parsing hero products from homepage")
        hero_products = self.parser.parse_hero_products_from_html(main_html) if main_html else []
